      ...
      <div className="flex-1 flex flex-col">
        <div className="bg-white border-b px-8 h-16 flex items-center justify-between"
          ...
          <div className="text-xs font-semibold px-3 py-1 rounded-full"
            style={{ background: '#FFFBE6', color: '#B45309', border: '1px solid #FDE68A' }}>
            Bienvenido
          </div>
        </div>
        ...
        <div className="p-8">
          ...
          <div className="grid grid-cols-3 gap-4 mb-8">
            {[
              { label: 'Estado', value: 'Sin iniciar', sub: 'Listo para empezar' },
              { label: 'Avance', value: '0%', sub: 'De la inducción' },
              { label: 'Certificado', value: '—', sub: 'Pendiente' },
            ].map((stat, i) => (
              <div key={i} className="bg-white rounded-xl p-5 border" style={{ borderColor: '#E8E8E0' }}>
                <div className="text-xs font-bold uppercase tracking-widest mb-2"
                  style={{ color: '#9A9AAA' }}>{stat.label}</div>
                <div className="text-xl font-bold" style={{ color: '#1A1A2E' }}>{stat.value}</div>
                <div className="text-xs mt-1" style={{ color: '#9A9AAA' }}>{stat.sub}</div>
              </div>
            ))}
          </div>
          ...
          <div className="bg-white rounded-2xl overflow-hidden border max-w-md cursor-pointer hover:shadow-lg transition-all"
            ...
            <div className="p-5">
              <div className="flex justify-between text-xs mb-2">
                <span style={{ color: '#9A9AAA' }}>Avance</span>
                <strong style={{ color: '#1A1A2E' }}>0%</strong>
              </div>
              <div className="h-1.5 rounded-full mb-4" style={{ background: '#E8E8E0' }}>
